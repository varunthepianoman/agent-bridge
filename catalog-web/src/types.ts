export type ConversationStatus =
  "active" | "idle" | "completed" | "failed" | "unknown";
...
export interface InteractiveOpenTarget {
  available: boolean;
  url?: string;
  command?: string;
  reason?: string | null;
...
export interface InteractiveOpenOptions {
  desktop: InteractiveOpenTarget;
  terminal: InteractiveOpenTarget;
}
...
export interface Conversation {
  ...
  interactive_open?: InteractiveOpenOptions;
}
...
export type RoleType =
  "portfolio_coordinator" | "work_coordinator" | "worker" | "specialist";
...
export type BridgeEndpointKind =
  "conversation" | "role" | "node" | "capability" | "room" | "endpoint";
export type BridgeMessageKind =
  "message" | "request" | "event" | "response" | "control";
export type BridgeOperation =
  "new_execution" | "resume_conversation" | "wake_endpoint" | "invoke_adapter";
